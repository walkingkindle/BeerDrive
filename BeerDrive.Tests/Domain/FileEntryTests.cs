...
namespace BeerDrive.Tests.Domain
{
    public class FileEntry_Tests
    {
        ...
        public void Create_Should_Succeed_With_Valid_ValueObjects()
        {
            ...
            var fileSize = FileSize.Create(100, "MB").Value;
        ...
        {
            var result = FileEntry.Create("file", "png", 100, "MB", FileType.Image);
            ...
            entity.Size.Unit.Should().Be("MB");
        }

        [Fact]
        public void Create_With_Primitives_Should_Fail_When_FileName_Invalid()
        {
            var result = FileEntry.Create("", "png", 100, "MB", FileType.Image);
        ...
        {
            var result = FileEntry.Create("file", "png", -1, "MB", FileType.Image);
